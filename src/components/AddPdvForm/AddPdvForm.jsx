...
import {
  addPdvAction,
  addPdvResponseAction,
  errorAction,
} from "./../../store/reducers/pdv/pdv.actions";
import {
  selectPdvErrors,
  selectPdvResponses,
} from "../../store/reducers/pdv/pdv.selector";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-2">Ajouter un pdv</div>
      </button>
                  ...
                  <div className="col-sm-10">
                    <input
                      ...
                      className={`form-control ${
                        errors != null && errors.PhoneNumber != null
                          ? "is-invalid"
                          : ""
                      }`}
                      id="phoneNumber"
